...
<nav class="navbar header-navbar pcoded-header">
    <div class="navbar-wrapper">
        <div class="navbar-logo">
            ...
            <a href="<%= request.getContextPath() %>/pages/telainicial.jsp">
                <h5 class="m-b-10" style="margin-left: 20px"><span><i class="fa fa-book" aria-hidden="true"></i></span> Curso JSP</h5>
            </a>
