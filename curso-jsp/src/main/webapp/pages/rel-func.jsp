						...
						<div class="page-header">
							<div class="page-block">
								<div class="row align-items-center">
									<div class="col-md-8">
										<h2 class="page-title">Relatório de funcionário</h2>
									</div>
									<div class="col-md-4">
														...
														<c:if test="${listaFunc != null}">
															<div class="table-responsive">
																<table class="table table-hover"
																	...
																	<tbody>
																	  <c:forEach items="${listaFunc}" var="mf">
																	  	<tr>
																	  		<td><c:out value="${mf.codigo}"></c:out></td>
																	  		<td><c:out value="${mf.nome}"></c:out></td>
																	  		<td><c:out value="${mf.email}"></c:out></td>
																	  		<td><c:out value="${mf.cargo}"></c:out></td>
																	  		<td><c:out value="${mf.salario}"></c:out></td>
																	  	</tr>
																	  </c:forEach>
																	</tbody>
																</table>
